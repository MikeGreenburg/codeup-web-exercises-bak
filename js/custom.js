...
var map = new mapboxgl.Map({
    ...
    zoom: 10,
    center: [-98.493629, 29.424122]//Longitude first and Latitude second
...
var markerOptions = {
    color: "#ff0000",//Sets the color of the marker
    draggable: true //Makes the marker able to be dragged around
};



var marker = new mapboxgl.Marker(markerOptions)//Links the markers characteristics = markerOptions with the actual Marker
    .setLngLat([-98.486145, 29.425966])
    .addTo(map);
