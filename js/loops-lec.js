...
// } while(!userConfirm); // can also be written while(userConfirm === false);
...
// for(var i = 0; i < randomColors.length, i++) {  // you want your loop to run the length of the loop
...
// another way to write it going by increments of 2
